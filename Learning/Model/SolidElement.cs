...
namespace Learning.Model
{
	public class SolidElement : Element
	{
        ...
        {
            return this.Name + ": Atomic mass of " + this.Mass + ". Try and see what else you can discover about it!";
        }
        ...
        public SolidElement MakeRandomElement(FieldJournal journal)
        {
            ...
            var rnd = new Random();
            var randomMass = rnd.Next(10, 300);
            ...
            {
                foreach (var elem in journal.GetKnownElements())
                {
            ...
            var randomMeltingPoint = rnd.Next(40, 3000);
            var randomBoilingPoint = randomMeltingPoint + (randomMeltingPoint / 10);
            var isAtomic = GetRadioactiveBool(randomMass, rnd);
            var randomVolatility = rnd.Next(1, 100);


            var newElement = new SolidElement(randomMass, randomMeltingPoint,
